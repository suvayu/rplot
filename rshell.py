...
class rshell(cmd.Cmd):
    ...
    def set_histfile(self, histfile):
        self.__histfile__ = histfile
        self.__pyhistfile__ = '{}.py'.format(histfile)
    ...
    def do_python(self, args=None):
        ...
        readline.write_history_file(self.__histfile__)
        readline.clear_history()  # remove rplotsh history from Python
        if os.path.exists(self.__pyhistfile__):
            readline.read_history_file(self.__pyhistfile__)
        ...
        readline.write_history_file(self.__pyhistfile__)
        if os.path.exists(self.__histfile__):
            readline.read_history_file(self.__histfile__)
